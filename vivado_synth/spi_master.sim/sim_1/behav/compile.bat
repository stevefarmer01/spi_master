...
xelab -m64 --debug typical --relax -L xil_defaultlib -L secureip --snapshot spi_master_tb_behav --prj D:/Projects/Vivado/2014_1/spi_master/vivado_synth/spi_master.sim/sim_1/behav/spi_master_tb.prj   xil_defaultlib.spi_master_tb
if errorlevel 1 (
