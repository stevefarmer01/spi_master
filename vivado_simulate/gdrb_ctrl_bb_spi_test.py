...
#  test_list_dict = {'0' : 'input_test_read_writes.txt', '1' : 'input_test_interupt_sensor.txt', '2' : 'input_test_interupt_fault.txt', '3' : 'input_test_interupt_misc.txt', '4' : 'input_test_vanilla_read_writes.txt'}
  test_list_dict = {'0' : ['input_test_read_writes.txt', r'simulate_gui.bat', r'simulate_no_gui.bat'], '1' : ['input_test_interupt_sensor.txt', r'simulate_gui.bat', r'simulate_no_gui.bat'], '2' : ['input_test_interupt_fault.txt', r'simulate_gui.bat', r'simulate_no_gui.bat'], '3' : ['input_test_interupt_misc.txt', r'simulate_gui.bat', r'simulate_no_gui.bat']}
  ...
  def copy_to_input_test_txt(self, test_number):
    ...
    print 'Copying file \'' + self.test_list_dict[test_number][0] + '\' to \'' + self.input_test_file + '\''
    shutil.copyfile(self.test_list_dict[test_number][0], self.input_test_file)
    return;
  ...
  def copy_results(self, test_number):
    ...
    if os.path.isfile(self.output_test_file):       # Copy will cause run time error if file doesn't exist
      shutil.copyfile(self.output_test_file, "test_results/" + test_number + '_results_' + self.test_list_dict[test_number][0])
